...
\end{center}
\caption{Up, blackbox step by step of executing a piece of code in Python (CPython). Down,
...
requireto code--among other things--memory management, garbage collection, function calling and return, type
